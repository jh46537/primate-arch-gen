...
cl::opt<ActionType> Action(
    ...
    cl::values(
        ...
        clEnumValN(GenPrimateCompressInst, "gen-primate-compress-inst-emitter",
                   "Generate Primate compressed instructions."),
