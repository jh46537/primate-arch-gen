//===-- PrimateTargetObjectFile.cpp - Primate Object Info -----------------===//
//
...
void PrimateELFTargetObjectFile::Initialize(MCContext &Ctx,
...
bool PrimateELFTargetObjectFile::isInSmallSection(uint64_t Size) const {
...
MCSection *PrimateELFTargetObjectFile::SelectSectionForGlobal(
...
void PrimateELFTargetObjectFile::getModuleMetadata(Module &M) {
...
bool PrimateELFTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *PrimateELFTargetObjectFile::getSectionForConstant(
