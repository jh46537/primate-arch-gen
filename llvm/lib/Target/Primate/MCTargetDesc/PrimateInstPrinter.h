//===-- PrimateInstPrinter.h - Convert Primate MCInst to asm syntax ---*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a Primate MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_PRIMATE_MCTARGETDESC_PRIMATEINSTPRINTER_H
#define LLVM_LIB_TARGET_PRIMATE_MCTARGETDESC_PRIMATEINSTPRINTER_H
...
class PrimateInstPrinter : public MCInstPrinter {
public:
  PrimateInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
  ...
  virtual void printRegName(raw_ostream &O, MCRegister RegNo) const override;
