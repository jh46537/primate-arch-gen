//===-- PrimateELFStreamer.h - Primate ELF Target Streamer ---------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_PRIMATE_PRIMATEELFSTREAMER_H
#define LLVM_LIB_TARGET_PRIMATE_PRIMATEELFSTREAMER_H
...
class PrimateTargetELFStreamer : public PrimateTargetStreamer {
private:
...
public:
  ...
  PrimateTargetELFStreamer(MCStreamer &S, const MCSubtargetInfo &STI);
