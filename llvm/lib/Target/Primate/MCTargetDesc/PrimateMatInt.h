//===- PrimateMatInt.h - Immediate materialisation ---------------*- C++ -*--===//
//
...
#ifndef LLVM_LIB_TARGET_PRIMATE_MATINT_H
#define LLVM_LIB_TARGET_PRIMATE_MATINT_H
...
// `Size`-bit immediate.
//
// If CompressionCost is true it will use a different cost calculation if PRC is
